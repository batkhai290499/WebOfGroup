...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is Property with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="" target="_blank">Haha</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
